...
const get_all_transaction_dto_1 = require("./dto/get-all-transaction.dto");
...
let TransactionsController = class TransactionsController {
    ...
    async findAll(getAllTransactionDto, currentUser) {
        const { items, meta } = await this.transactionsService.findAll(getAllTransactionDto, currentUser);
        return {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_all_transaction_dto_1.GetAllTransactionDto,
        user_entity_1.User]),
